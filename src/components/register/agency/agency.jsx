  ...
  return (
    <div className="register--container">    
      <div className="register--container-register">
        ...
        {/* Modal to show errors if there are any. */}
        {isModalOpen && (
          <div>
        ...
        <div className="bottom">
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data">
            <input type="file" id="cac" name='cac_document' onChange={handleFileChange} placeholder='CAC document' required className='file'/>
            <input type="text" id="name" name='name' value={formData.name} onChange={handleChange} placeholder='Agency name' required/>
            <input id="agent-url" name='link' value={formData.link} onChange={handleChange} placeholder='Agency Website/Social media Link'/>
